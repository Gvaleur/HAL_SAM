...
void __attribute__ ((weak, naked)) Reserved11() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
	//	extern "C" void Reserved11();
	__asm("bkpt 255");
	__asm("bx lr");
}
void __attribute__ ((weak, naked)) Reserved12() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
	//	extern "C" void Reserved12();
	__asm("bkpt 255");
	__asm("bx lr");
}
...
void Reserved11()         __attribute__ ((weak, alias ("Default_Handler")));
void Reserved12()         __attribute__ ((weak, alias ("Default_Handler")));
