...
void __attribute__ ((weak)) Reserved13() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
	//	extern "C" void Reserved13();
	asm("bkpt 255");
}

void __attribute__ ((weak)) Reserved14() 
{
	//If you hit the breakpoint below, one of the interrupts was unhandled in your code. 
	//Define the following function in your code to handle it:
	//	extern "C" void Reserved14();
	asm("bkpt 255");
}
...
void Reserved13()         __attribute__ ((weak, alias ("Default_Handler")));
void Reserved14()         __attribute__ ((weak, alias ("Default_Handler")));
