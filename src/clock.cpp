...
#define XOSCCTRL XOSC
#define OSCCTRL_XOSCCTRL_STARTUP SYSCTRL_XOSC_STARTUP
#define OSCCTRL_XOSCCTRL_GAIN SYSCTRL_XOSC_GAIN
#define OSCCTRL_XOSCCTRL_XTALEN SYSCTRL_XOSC_XTALEN
#define OSCCTRL_XOSCCTRL_ENABLE SYSCTRL_XOSC_ENABLE
